...
?>
    ...
    <body>
        ...
        <!-- Formulario para o envio de informações de cadastro para o arquivo "cad_empresa.php" -->
        <div class="formulario">
            <form action="cad_empresa.php" method="post" class="form">
                <div class="mb-3">
                    <label class="texto1">Nome da empresa</label>
                ...
                <div class="mb-3">
                    <label >CNPJ</label>
                    <input type="text" name="cnpj" id="cnpj" placeholder="Apenas os numeros"  required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label >Usuario de acesso</label>
                    <input type="text" name="usuario" id="usuario" placeholder="..."  required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="telefone" id="telefone" placeholder="..."  required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="botao">
